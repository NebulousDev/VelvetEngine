...
public class OBJParser
{
	...
	{
		// Read File //
		String filedata = FileUtils.readFileAsString(filepath);
		
		if(filedata == null)
			System.out.println("[VELVET OBJ] Failed to parse OBJ. File returned null.");
		
		sFilepath 		= filepath;
		sFolderpath 	= FileUtils.getContainingFolder(filepath);
		sLinenumber 	= 0;
	...
	{
		String filedata = FileUtils.readFileAsString(folderpath + "/" + tokens[1]);
